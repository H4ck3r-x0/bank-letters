...
return [
    ...
    */
    ...
    'string' => 'يجب أن يكون :attribute عبارة عن نص.',
    ...
    */
    ...
    'attributes' => [
        ...
        'employee_count' => 'إجمالي العمالة',
        'compressor_count' => 'إجمالي الضواغط',
        'broom_count' => 'إجمالي المكانس',
        'bobcat_count' => 'إجمالي البوبكات',
        'tipper_count' => 'إجمالي القلابات',
        'moderators_count' => 'إجمالي المشرفين',
        'monitors_count' => 'إجمالي المراقبين',
        'drivers_count' => 'إجمالي السائقين',
        'note' => 'ملاحظات',
        'userType' => 'نوع المستخدم',
        'importance' => 'الأهمية',
        'message' => 'التوجيه',
        'sub_region_name' => 'المنطقة الفرعية',
        'sub_region_id' => 'المنطقة الفرعية',
        'compacting_waste_count' => 'كبس النفايات',
        'broadway_count' => 'كناسة برودوي',
        'sidewalk_sweeper_count' =>  'كناسة غسيل ارصفة',
        'roll_on_container_count' => 'حاويات رول اون',
        'small_tipper_count' => 'قلابات صغيرة',
        'sheol_count' => 'شويل كبير',
        'mid_sheol_count' => 'شويل متوسط',
        'small_sheol_count' => 'شويل صغير',
        'container_washing_car_count' => 'سيارات غسيل الحاويات',
        'pick_up_small_count' => 'ونيت صغير',
        'wheelbarrow_count' => 'عربية يدوية',
        'shovels_count' => 'جوارف',
        'thistle_count' => 'شوك',
        'worker_card_count'     => 'بطاقات العاملين',
        'official_wear_count' => 'زي العمال',
    ],
